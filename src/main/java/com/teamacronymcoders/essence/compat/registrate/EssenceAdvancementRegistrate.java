...
public class EssenceAdvancementRegistrate {
    ...
    public static void knowledgeAdvancements(RegistrateAdvancementProvider provider) {
        knowledgeRoot = Advancement.Builder.advancement()
                ...
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.TOME_OF_KNOWLEDGE.get()))
    ...
    public static void miscAdvancements(RegistrateAdvancementProvider provider) {
        tiers = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.TOME_OF_KNOWLEDGE.get(),
        ...
        basic = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_INGOT.get(),
                ...
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_INGOT.get()))
                .save(provider, "essence:knowledge/material/basic");

        empowered = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_INGOT_EMPOWERED.get(),
                ...
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_INGOT_EMPOWERED.get()))
                .save(provider, "essence:knowledge/material/empowered");

        supreme = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_INGOT_SUPREME.get(),
                ...
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_INGOT_SUPREME.get()))
                .save(provider, "essence:knowledge/material/supreme");

        divine = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_INGOT_DIVINE.get(),
                ...
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_INGOT_DIVINE.get()))
                .save(provider, "essence:knowledge/material/divine");
        toolTypes = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_AXE.get(),
        ...
        axe = Advancement.Builder.advancement()
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_AXE.get()))
                .save(provider, "essence:knowledge/tools/essence_axe");

        bow = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_BOW.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_BOW.get()))
                .save(provider, "essence:knowledge/tools/essence_bow");

        hoe = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_HOE.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_HOE.get()))
                .save(provider, "essence:knowledge/tools/essence_hoe");

        omniTool = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_OMNITOOL.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_OMNITOOL.get()))
                .save(provider, "essence:knowledge/tools/essence_omnitool");

        pickaxe = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_PICKAXE.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_PICKAXE.get()))
                .save(provider, "essence:knowledge/tools/essence_pickaxe");

        shear = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_SHEAR.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_SHEAR.get()))
                .save(provider, "essence:knowledge/tools/essence_shear");

        shovel = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_SHOVEL.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_SHOVEL.get()))
                .save(provider, "essence:knowledge/tools/essence_shovel");

        sword = Advancement.Builder.advancement()
                .display(
                        EssenceItemsRegistry.ESSENCE_SWORD.get(),
                ...
                .parent(toolTypes)
                .addCriterion("tome_of_knowledge", InventoryChangeTrigger.TriggerInstance.hasItems(EssenceItemsRegistry.ESSENCE_SWORD.get()))
    ...
    public static Item getDefaultIcon() {
        return EssenceItemsRegistry.ESSENCE_CRYSTAL.get();
    }
