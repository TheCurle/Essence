    ...
    public static void init(Registrate registrate) {
        ...
        registrate.addDataGenerator(ProviderType.ITEM_TAGS, provider -> {
            ...
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.MINEABLE_AXE)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_AXE.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_AXE_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_AXE_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_AXE_DIVINE.getId(), Essence.MOD_ID);
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.MINEABLE_PICKAXE)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_PICKAXE.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_PICKAXE_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_PICKAXE_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_PICKAXE_DIVINE.getId(), Essence.MOD_ID);
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.MINEABLE_SHOVEL)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHOVEL.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHOVEL_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHOVEL_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHOVEL_DIVINE.getId(), Essence.MOD_ID);
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.MINEABLE_HOE)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_HOE.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_HOE_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_HOE_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_HOE_DIVINE.getId(), Essence.MOD_ID);
            ...
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.ESSENCE_BOW)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_BOW_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_BOW_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_BOW_DIVINE.getId(), Essence.MOD_ID);
            ...
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.ESSENCE_OMNITOOL)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_OMNITOOL_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_OMNITOOL_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_OMNITOOL_DIVINE.getId(), Essence.MOD_ID);
            ...
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.ESSENCE_SHEAR)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHEAR_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHEAR_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SHEAR_DIVINE.getId(), Essence.MOD_ID);
            ...
            provider.getOrCreateRawBuilder(EssenceTags.EssenceItemTags.ESSENCE_SWORD)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SWORD_EMPOWERED.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SWORD_SUPREME.getId(), Essence.MOD_ID)
                    .addOptionalElement(EssenceItemsRegistry.ESSENCE_SWORD_DIVINE.getId(), Essence.MOD_ID);
